...
public class GameApp {
    ...
    public static void main(String[] args){
        ...
        displayMatchResult();
        System.out.println("Bledy w calym meczu "  + sumaBledow);
    }
    ...
    private static String readUserHand(){
        ...
        do {
            hand = scanner5.nextLine();
            if (!(hand.equals("kamien") || hand.equals("nozyce") || hand.equals("papier"))) {
                System.out.println("Wpisales niepoprawne dane. Sprobuj jeszcze raz");
                blad++;
                sumaBledow++;
                System.out.println(blad);
            }
        }
        while  ((blad<=3 ) &&  (!((hand.equals("kamien") || hand.equals("nozyce") || hand.equals("papier")))));
